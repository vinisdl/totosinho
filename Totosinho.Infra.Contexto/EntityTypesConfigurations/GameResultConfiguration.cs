        ...
        public GameResultConfiguration()
        {
            ...
            Property(x => x.PlayerId)
                ...
                .HasColumnAnnotation(IndexAnnotation.AnnotationName,
                    new IndexAnnotation(new IndexAttribute("IX_PLAYER_ID", 1)));
            Property(x => x.GameId)
                .HasColumnName("game_id")
                .HasColumnAnnotation(IndexAnnotation.AnnotationName,
                    new IndexAnnotation(new IndexAttribute("IX_GAME_ID", 2)));
            ...
            Property(a => a.ServidorCod).HasColumnName("servidor_cod")
                .HasColumnAnnotation(IndexAnnotation.AnnotationName,
                    new IndexAnnotation(new IndexAttribute("IX_SERVIDOR_COD", 3)));
        }
    }
}